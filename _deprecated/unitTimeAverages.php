...
$averageData = AverageEchoTimes($AllEchoData);
...
<script>
    ...
    var averages = <?php echo json_encode($averageData) ?>;
    var json = [];



    /* [
      {date: Sat Oct 01 2011 00:00:00 GMT+1000 (Australian Eastern Standard Time), Student 1: "63.4", Avg. Unit Time: "62.7"},
      ] */
    ...
    for (index in studentArray) {
        ...
        dataset.student = studentArray[index];
        dataset.unitavg = averages[index];
        json.push(dataset);
    }
console.log(dataset);
//
//    var studentArray = <?php //echo json_encode($studentData)?>//;
//    var averages = <?php //echo json_encode(AverageEchoTimes($AllEchoData))?>//;
//    var data = [];
