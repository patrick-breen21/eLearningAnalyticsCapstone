...
$Allaverages = AverageEchoTimes($AllEchoData);
$Allaverages = [10, 10, 20, 11, 60, 55, 60, 65, 70, 90, 80, 100];

$studentData = [10, 13, 20, 11, 30, 40, 70, 90, 80, 70, 120, 50];
?>
<script>
    var studentArray = <?php echo json_encode($studentData)?>;
    var averages = <?php echo json_encode($Allaverages)?>;
    var data = [];
