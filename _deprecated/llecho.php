...
var LLData = <?php echo json_encode(GetEchoTimeUser($_SESSION['user']['hash'])) ?>;
...
var yScale = d3.scale.linear()
    .domain([0, d3.max(LLData)])
    .range([0, height]);
//yAxis creation
var xScale = d3.scale.ordinal()
    .domain(d3.range(0, LLData.length))
    .rangeBands([0, width]);
var colours = d3.scale.linear()
    .domain([0, LLData.length])
    .range(['#2eee3e', '#30c230']);
